---
title: 'Tor 재단에서 티셔츠를 받았습니다'
subtitle: '릴레이 운영 업적 달성'
author: 'LiteHell'
date: '2025-11-23T13:50:48.133Z'
category: 'Life'
tags:
    - 'Tor'
    - 'Relay'
...
![특정 조건 만족시 Tor 티셔츠를 받을 수 있다는 게시글](./tor_swag_article.png)

최소 6개월 이상 Tor 릴레이를 운영하면 티셔츠를 받을 수 있다고 한다. 어? 이거 완전 나잖아.
그래서 바로 메일을 보냈다.

![요청 메일](./request_mail.png)

그리고 며칠 지나고 나서 자격이 된다는 메일이랑 곧 보내주겠다는 메일을 받았다.

![첫번째 메일](./first_mail.png)

![곧 보내주겠다는 메일](./follow_up_mial.png)

그리고 잊을 때쯤 되면 추적 링크가 온다.

![추적 링크가 있는 메일](./tracking_link_mail.png)
